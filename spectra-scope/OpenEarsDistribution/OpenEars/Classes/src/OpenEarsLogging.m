...
+ (id)startOpenEarsLogging
{
    ...
    openears_logging = 1;
    NSLog(@"Starting OpenEars logging for OpenEars version %@ on device: %@ running iOS version: %f",kCurrentVersion,[[UIDevice currentDevice]model ], [[[UIDevice currentDevice] systemVersion] floatValue]);
